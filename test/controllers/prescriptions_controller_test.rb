...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { consultation_id: @prescription.consultation_id, description: @prescription.description } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { consultation_id: @prescription.consultation_id, description: @prescription.description } }
